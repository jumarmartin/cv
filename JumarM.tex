...
\begin{document}
\biodata{Jumar A. Martin}{\href{mailto:jumar@jumart.in}{jumar@jumart.in} | \href{tel:16504079719}{+1 (650) 407-9719}}{Fourth-Year CS \& Econ Student, Internet Frontiersman}
...
\begin{itemize}
    ...
    \openitem{ods.elon.edu}{As the Founder of the Open Data Service at Elon, I led a cross-functional organization in designing and implementing a cutting-edge service that streamlined data access for the university community by architecting a scalable service. Utilizing a \textbf{dependency injection} paradigm and automating deployment with \textbf{Terraform} and \textbf{Docker}, we taught members how to contribute to open-source projects and use tools that they'll see when they enter the workforce. \url{https://github.com/elonsoc/ods}}
\end{itemize}
