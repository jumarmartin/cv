...
\begin{itemize}
    ...
    {
        \begin{itemize}
            \openitem{}{Founded with 2 other high school students, Eclect---which stems from the word eclectic---is a company with the intent to change the world, no matter how clich\'e that may sound.}
...
\begin{itemize}
    ...
    {As a student at Elon University, I recognized the need for greater access to university data and founded the CS Project Team, a group dedicated to delivering innovative solutions to the Elon community. Our first major project was an ambitious initiative to create a platform for Elon affiliates to access previously inaccessible data. Through extensive collaboration with university stakeholders, we established a groundbreaking partnership between students and the institution, paving the way for future technical partnerships and creating a new paradigm for student-university interaction. I led a team in delivering a product that transformed the way students and faculty interacted with university data, providing open access to information and creating new opportunities for innovation, research, and problem-solving on campus.
        % {After founding the CS Project Team, I built and launched api.elon.edu, a greenfield initiative to bring Open Data to Elon, from ideation to implementation, leading a team of stuents to deliver a platform for affiliates to build products that leverage private Elon data to improve life on campus. With this initative being the first of its kind in Elon's history, I worked with the university to create a new process for student-university technical partnerships.}
    }
    \secitem{President}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
    \secitem{Section Leader}
    {Stanford University Code in Place}
    {Apr. 2023}{Jun. 2023}
    {
        Code in Place is a free, introductory, online Python programming course, consisting of the first half of the introductory programming course taught by Stanford University professors and teaching assistants.
        I served as a section leader for the Spring 2023 cohort, leading a group of 10 students through the course materials and providing feedback on assignments and projects.
    }
...
\begin{itemize}
    ...
    \openitem{ods.elon.edu}{The product that spawned the creation of the CS Project Team, ods.elon.edu is a greenfield initiative to bring Open Data to Elon.
    I architected the service, documented in \textbf{OpenAPI}, wrote in \textbf{Go} using a \textbf{dependency injection} paradigm, backed by a \textbf{PostgreSQL} database, and deployed on programmatically using \textbf{Terraform}. \url{https://github.com/elonsoc/ods}}
\end{itemize}
